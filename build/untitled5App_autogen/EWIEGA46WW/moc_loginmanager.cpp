...
constexpr auto qt_meta_stringdata_CLASSLoginManagerENDCLASS = QtMocHelpers::stringData(
    "LoginManager",
    "loginSucceeded",
    "",
    "loginFailed",
...
Q_CONSTINIT const QMetaObject LoginManager::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoginManagerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<LoginManager, std::true_type>,
...
void LoginManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginManager::loginSucceeded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LoginManager::*)(const QString & );
            if (_t _q_method = &LoginManager::loginFailed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LoginManager::loginSucceeded()
{
